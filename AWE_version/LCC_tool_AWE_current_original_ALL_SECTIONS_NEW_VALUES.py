# AWE original all sections with current values
...
# 🔴 GEÄNDERT: original CAPEX cell retained, but technology changed from PEMWE to AWE with updated AWE prices.
...
# 🔴 GEÄNDERT: updated current AWE prices
price = [0.72, 16.150470, 11.649982, 150.0, 13.658247, 1.151118, 166.91, 1.19,
         904.38, 2506.595, 2735.0, 497.0, 15000.0, 13159.68, 4750.0]
...
# 🔴 GEÄNDERT: original Monaco material-cost section retained; material variables changed from PEMWE to AWE.
...
# Variables used in the simulation
sim.addInVar(name='Steel', dist=uniform, distkwargs={'loc': 0.58, 'scale': 0.29})
sim.addInVar(name='Nickel', dist=uniform, distkwargs={'loc': 12.9, 'scale': 6.5})
sim.addInVar(name='Copper', dist=uniform, distkwargs={'loc': 9.3, 'scale': 4.7})
sim.addInVar(name='Zirfon Membrane', dist=uniform, distkwargs={'loc': 120, 'scale': 60})
sim.addInVar(name='PTFE', dist=uniform, distkwargs={'loc': 10.9, 'scale': 5.5})
sim.addInVar(name='HDPE', dist=uniform, distkwargs={'loc': 0.9, 'scale': 0.5})
sim.addInVar(name='Power cable', dist=uniform, distkwargs={'loc': 130, 'scale': 75})
sim.addInVar(name='Data cable', dist=uniform, distkwargs={'loc': 0.95, 'scale': 0.5})
sim.addInVar(name='KOH tank', dist=uniform, distkwargs={'loc': 700, 'scale': 500})
sim.addInVar(name='Gas separator', dist=uniform, distkwargs={'loc': 2000, 'scale': 1000})
sim.addInVar(name='Heat exchanger', dist=uniform, distkwargs={'loc': 2200, 'scale': 1000})
sim.addInVar(name='Water pump', dist=uniform, distkwargs={'loc': 400, 'scale': 300})
sim.addInVar(name='Rectifier / power electronics', dist=uniform, distkwargs={'loc': 12000, 'scale': 6000})
sim.addInVar(name='Control unit', dist=uniform, distkwargs={'loc': 10500, 'scale': 5500})
sim.addInVar(name='Housing', dist=uniform, distkwargs={'loc': 3800, 'scale': 2000})
...
# 🔴 GEÄNDERT: original EoL table retained, but material list changed from PEMWE to AWE.
...
# 🔴 GEÄNDERT: original OPEX section retained; AWE production, electricity, water and KOH inputs inserted.
...
lcoh_s1_mean = levelized_cost_of_h2(life_cycle_cost_of_h2=lcc_S1_mean, h2_production=19588000  # 🔴 GEÄNDERT: AWE lifetime H2 production, **kwargs)
...
lcoh_s1_high = levelized_cost_of_h2(life_cycle_cost_of_h2=lcc_S1_high, h2_production=19588000  # 🔴 GEÄNDERT: AWE lifetime H2 production, **kwargs)
...
lcoh_s1_low = levelized_cost_of_h2(life_cycle_cost_of_h2=lcc_S1_low, h2_production=19588000  # 🔴 GEÄNDERT: AWE lifetime H2 production, **kwargs)
...
lcoh_s2_mean = levelized_cost_of_h2(life_cycle_cost_of_h2=lcc_S2_mean, h2_production=19588000  # 🔴 GEÄNDERT: AWE lifetime H2 production, **kwargs)
...
lcoh_s2_high = levelized_cost_of_h2(life_cycle_cost_of_h2=lcc_S2_high, h2_production=19588000  # 🔴 GEÄNDERT: AWE lifetime H2 production, **kwargs)
...
lcoh_s2_low = levelized_cost_of_h2(life_cycle_cost_of_h2=lcc_S2_low, h2_production=19588000  # 🔴 GEÄNDERT: AWE lifetime H2 production, **kwargs)
...
sim.addInVar(name='h2_production', dist=uniform, distkwargs={'loc': 18000000, 'scale': 4000000})  # 🔴 GEÄNDERT: AWE H2 production range 
