...
def prophet_fit_predict_water(odf, var="BNV", years=50, plot=True):
    ...
    future = ['2025-07-31']  # 🔴 GEÄNDERT: forecast starts at last historical period after extending history to 2025-S2
    for i in range(26, 26+years):  # 🔴 GEÄNDERT: 2026 onward after 2025 history
            for j in [1, 7]:
...
# 🔴 GEÄNDERT: additional AWE material-cost function, original PEMWE function above is kept unchanged.
